...
public enum ActionModel {
	...
	AI_SEARCH(MENU_TOOLBAR, "menu.ai_search", "menu.ai_search", "ui/ollama",
			Shortcut.keyboard(KeyEvent.VK_U, UiUtils.ctrlButton())),
	...
	AI_Translate(CODE_AREA, "popup.translate", "popup.translate", null,
			Shortcut.keyboard(KeyEvent.VK_J)),

	AI_Audit(CODE_AREA, "popup.audit", "popup.audit", null,
			Shortcut.keyboard(KeyEvent.VK_K)),
	AI_SETTING(MENU_TOOLBAR, "menu.aisetting", "menu.aisetting", "ui/ollama",
			Shortcut.none()),
